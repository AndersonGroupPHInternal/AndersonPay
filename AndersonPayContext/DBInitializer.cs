           ...
           List<ECurrencyCode> currencyCodes = new List<ECurrencyCode>()
            ...
            List<ECompanyAddress> companyAddress = new List<ECompanyAddress>()
            {
                new ECompanyAddress
                {
                    ...
                    Address = "11/F Wynsum Corporate Plaza, #22 F. Ortigas Jr. Road Ortigas Center, Brgy San Antonio, Pasig City Philippines ",
                    SINo = "WNSM-",
                    TIN = "009-490-545-001"
                },
                ...
                new ECompanyAddress
                {
                    ...
                    Address = "15/F Ecotower Building Unit 1504, 32nd Street corner 9th avenue Fort Bonifacio, Taguig City Philippines",
                    SINo = "ECT-",
